...
Singleton {
    id: root
    property string filePath: StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/.local/share/axide/user/config.json"
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject misc: JsonObject {
                ...
                property url pfp: StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/.local/share/axide/defaults/pfp.png"
            }

            property JsonObject background: JsonObject {
                property bool wallpaperEnabled: true
                property url wallpaperPath: StandardPaths.writableLocation(StandardPaths.HomeLocation) + "/.local/share/axide/defaults/wallpaper.jpg"
